...
* Резюме:
* + Стартует работает правильно
* + Ecть пакет, но с неправильным именем д.б com.hw01_testrunner
* - DSL нет
* - Generic не ограничен - м.б. null 
* + Сделана хитрая и правильная функция расширения
* - Последний член в лямбду не вынесен и перемудрено
* - Вариант классов один и самый примитивный - добавил 
* - 
